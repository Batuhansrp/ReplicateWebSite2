...
namespace ReplicateWeb.Controllers
{
    ...
    public class DemoController : Controller
    {
        ...
        [HttpPost]
        public ActionResult DemoForm(string firstname, string lastname, string workemail, string phone, string companyname, string companysize)
        {
            ...
            try
            {
                ...
                string kayit = "insert into tablo(firstname,lastname,workemail,phone,companyname,companysize) values (@firstname,@lastname,@workemail,@phone,@companyname,@companysize)";
            ...
            return RedirectToAction("DemoSayfasi", "Home");
